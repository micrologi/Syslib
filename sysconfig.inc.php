...
$sysconf['mail']['server'] = 'mail.micrologi.com.br'; // SMTP server
$sysconf['mail']['server_port'] = 587; // the SMTP port
$sysconf['mail']['auth_enable'] = true; // enable SMTP authentication
$sysconf['mail']['auth_username'] = 'contato@micrologi.com.br'; // SMTP account username
$sysconf['mail']['auth_password'] = 'mj?24ca!84'; // SMTP account password
$sysconf['mail']['from'] = 'contato@micrologi.com.br';
$sysconf['mail']['from_name'] = 'Micrologi';
...
$sysconf['OAI']['Identify']['adminEmail'] = 'contato@micrologi.com.br';
