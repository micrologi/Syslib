...
--
-- Host: 127.0.0.1
-- Tempo de geração: 15/05/2014 às 22:37
...
(3, 'Bem Vindo', '<table style="width: 100%;" border="0" cellspacing="0" cellpadding="5">\r\n<tbody>\r\n<tr>\r\n<td width="5%" valign="top"><a class="icon biblioIcon" href="?mod=bibliography"></a></td>\r\n<td width="45%" valign="top">\r\n<div class="heading">Acervo<br /></div>\r\nO acervo compreende os materiais bibliogr&aacute;ficos dispon&iacute;veis na biblioteca. S&atilde;o os livros, revistas, cat&aacute;logos, CDs, etc. &Eacute; necess&aacute;rio a inclus&atilde;o do acervo para que possa ser utilizado a op&ccedil;&atilde;o de circula&ccedil;&atilde;o por parte dos associados.<br /></td>\r\n<td width="5%" valign="top"><a class="icon circulationIcon" href="?mod=circulation"></a></td>\r\n<td width="45%" valign="top">\r\n<div class="heading">Circula&ccedil;&atilde;o</div>\r\n<span id="result_box" lang="pt">&Eacute;<span class="hps"> utilizado nas </span><span class="hps">transa&ccedil;&otilde;es</span> <span class="hps">de circula&ccedil;&atilde;o</span> <span class="hps">do acervo da biblioteca</span><span>, como empr&eacute;stimos</span><span class="hps">, coleta e</span> <span class="hps">retorno.</span> <span class="hps">Neste m&oacute;dulo, </span><span class="hps">tamb&eacute;m &eacute; poss&iacute;vel criar regras</span> <span class="hps">de empr&eacute;stimos que</span> <span class="hps">ser&atilde;o utilizadas na</span> <span class="hps">opera&ccedil;&atilde;o de empr&eacute;stimo</span></span>.</td>\r\n</tr>\r\n<tr>\r\n<td width="5%" valign="top"><a class="icon memberIcon" href="?mod=membership"></a></td>\r\n<td width="45%" valign="top">\r\n<div class="heading">Associados</div>\r\nOs associados s&atilde;o as pessoas&nbsp; que poder&atilde;o reservar a alugar os materiais bibliogr&aacute;ficos da biblioteca (acervo). Utilize este m&oacute;dulo para gerenciar os associados e os tipos de associados.<br /><br /></td>\r\n<td width="5%" valign="top"><a class="icon stockTakeIcon" href="?mod=stock_take"></a></td>\r\n<td width="45%" valign="top">\r\n<div class="heading">Invent&aacute;rio</div>\r\nO m&oacute;dulo de invent&aacute;rio permite controlar de forma simples, a quantidade de itens do acervo bibliogr&aacute;fico da biblioteca. Siga os procedimentos deste m&oacute;dulo e gerencie o invent&aacute;rio atrav&eacute;s de um processo simples.<br /><br /></td>\r\n</tr>\r\n<tr>\r\n<td width="5%" valign="top"><a class="icon masterFileIcon" href="?mod=master_file"></a></td>\r\n<td width="45%" valign="top">\r\n<div class="heading">Cadastros</div>\r\nTodos os cadastros b&aacute;sicos (de base) est&atilde;o contidos neste m&oacute;dulo. &Eacute; neste m&oacute;dulo que devem ser adicionados as categorias, editoras, fornecedores, autores e demais informa&ccedil;&otilde;es que servem de base para outros m&oacute;dulos.<br /></td>\r\n<td width="5%" valign="top"><a class="icon systemIcon" href="?mod=system"></a></td>\r\n<td width="45%" valign="top">\r\n<div class="heading">Sistema</div>\r\n&Eacute; nesta op&ccedil;&atilde;o que as configura&ccedil;&otilde;es b&aacute;sicas do sistema s&atilde;o realizadas. Nesta op&ccedil;&atilde;o &eacute; poss&iacute;vel encontrar tamb&eacute;m, rotinas de manuten&ccedil;&atilde;o do sistema.</td>\r\n</tr>\r\n<tr>\r\n<td width="5%" valign="top"><a class="icon reportIcon" href="?mod=reporting"></a></td>\r\n<td width="45%" valign="top">\r\n<div class="heading">Relat&oacute;rios</div>\r\n<p>O m&oacute;dulo de relat&oacute;rios permite visualizar (em tempo real e com filtros) todos os dados de base (cadastros) e obter v&aacute;rias informa&ccedil;&otilde;es referentes aos dados bibliogr&aacute;ficos e de circula&ccedil;&atilde;o, incluindo devolu&ccedil;&otilde;es em atraso e multas.</p>\r\n<br /></td>\r\n<td width="5%" valign="top"><a class="icon serialIcon" href="?mod=serial_control"></a></td>\r\n<td width="45%" valign="top">\r\n<div class="heading">Controle de S&eacute;ries</div>\r\n<span id="result_box" lang="pt"><span class="hps">O m&oacute;dulo</span> <span class="hps">de Controle de S&eacute;ries </span><span class="hps">ajuda a gerenciar</span> acervos que s&atilde;o recebidos com certa frequ&ecirc;ncia, como revistas, publica&ccedil;&otilde;es, boletins e semelhantes.</span><br /></td>\r\n</tr>\r\n</tbody>\r\n</table>', 'adminhome', '2009-09-13 19:48:16', '2014-05-14 20:41:43', '1'),
...
(5, 'Figgins, Stephen', NULL, 'p', '', '2007-11-29', '2014-05-15'),
...
(25, 'Rubens Barbosa', NULL, 'p', '', '2014-05-15', '2014-05-15');
...
(1, 'Acervo Bibliográfico', 'bibliography', 'Gerencia o catálogo (livros, revistas, boletins, cds, etc.) da biblioteca'),
(2, 'Circulação', 'circulation', 'Reservas, empréstimos e devoluções do acervo bibliográfico'),
(3, 'membership', 'membership', 'Manage your library membership and membership type'),
(4, 'Cadastros', 'master_file', 'Cadastros básicos do sistema: Categorias, editoras, fornecedores, autores, etc.'),
(5, 'stock_take', 'stock_take', 'Ease your pain in doing library stock opname process'),
(6, 'Configurações', 'system', 'Configurações do sistema e ferramenta de backup'),
...
(2, 'library_subname', 's:27:"Gerenciamento de Biblioteca";'),
(3, 'template', 'a:2:{s:5:"theme";s:7:"default";s:3:"css";s:26:"template/default/style.css";}'),
(4, 'admin_template', 'a:2:{s:5:"theme";s:7:"meranti";s:3:"css";s:32:"admin_template/meranti/style.css";}'),
...
(31, 'staff', '1', 'system', 'Micrologi change application global configuration', '2014-05-12 23:29:55'),
(32, 'staff', '1', 'system', 'Micrologi change application global configuration', '2014-05-12 23:33:35'),
(33, 'staff', '1', 'system', 'Micrologi change application global configuration', '2014-05-12 23:33:53'),
(34, 'staff', '1', 'system', 'Micrologi change application global configuration', '2014-05-12 23:34:39'),
(35, 'staff', 'micrologi', 'Login', 'Login success for user micrologi from address ::1', '2014-05-14 04:16:13'),
(36, 'staff', 'micrologi', 'Login', 'Login success for user micrologi from address ::1', '2014-05-14 18:47:29'),
(37, 'staff', '1', 'system', 'Micrologi change application global configuration', '2014-05-14 19:03:17'),
(38, 'staff', '1', 'system', 'Micrologi change application global configuration', '2014-05-14 19:09:46'),
(39, 'staff', '1', 'system', 'update content data (Bem Vindo) with contentname ()', '2014-05-14 20:32:50'),
(40, 'staff', '1', 'system', 'update content data (Bem Vindo) with contentname ()', '2014-05-14 20:41:43'),
(41, 'staff', 'micrologi', 'Login', 'Login success for user micrologi from address ::1', '2014-05-15 18:51:46'),
(42, 'staff', '1', 'system', 'Micrologi update module data (Acervo Bibliográfico) with path (bibliography)', '2014-05-15 19:34:30'),
(43, 'staff', '1', 'system', 'Micrologi update module data (Circulação) with path (circulation)', '2014-05-15 19:35:34'),
(44, 'staff', '1', 'system', 'Micrologi update module data (Cadastros) with path (master_file)', '2014-05-15 19:36:32'),
(45, 'staff', '1', 'system', 'Micrologi update module data (Configurações) with path (system)', '2014-05-15 19:50:13'),
(46, 'member', '0001', 'circulation', 'Micrologi start transaction with member (0001)', '2014-05-15 21:35:31'),
(47, 'member', '0001', 'circulation', 'Micrologi finish circulation transaction with member (0001)', '2014-05-15 21:35:45'),
(48, 'member', '0001', 'circulation', 'Micrologi start transaction with member (0001)', '2014-05-15 21:35:52'),
(49, 'staff', '1', 'system', 'Micrologi Log Out from application from address ::1', '2014-05-15 22:29:22'),
(50, 'staff', 'micrologi', 'Login', 'Login success for user micrologi from address ::1', '2014-05-15 22:31:59');
...
(1, 'micrologi', 'Micrologi', '0ce11be6669e1bd428f667fea02c8994', NULL, NULL, NULL, NULL, '2014-05-15 22:31:59', '::1', 'a:1:{i:0;s:1:"1";}', '2014-05-10', '2014-05-10');
