...
var minute;
var second;
var month_names = new Array('Janeiro', 'Fevereiro', 'Março', 'Abril',
  'Maio', 'Junho', 'Julho', 'Agosto', 'Setembro',
  'Outubro', 'Novembro', 'Dezembro');
var day_names = new Array('Dom', 'Seg', 'Ter', 'Qua',
  'Qui', 'Sex', 'Sab');
...
function openCalendar(strDatefieldID) {
  if (calendarPop) {
    ...
    $(document.body).append('<div style="width: 300px;" id="calendarPop">'
      + '<div style="float: left; width: 70%">Calendário</div>'
      + '<div style="float: right; width: 20%; text-align: right;">'
      + '<a style="color: red; font-weight: bold; cursor: pointer;" onclick="calendarPop.hide()">Fechar</a>'
      + '</div>'
