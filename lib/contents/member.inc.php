...
<?php
    ...
    function showLoanList($num_recs_show = 20)
    {
        ...
        $_result = '<div class="memberLoanListInfo">'.$_loan_list->num_rows.' '.__('item(s) currently on loan').' | <a href="?p=download_current_loan">Seus empréstimos Atuais</a></div>'."\n".$_result;
        return $_result;
    }
    ...
    function showLoanHist($num_recs_show = 20)
    {
        ...
        $_result = '<div class="memberLoanHistInfo"> &nbsp;'.$_loan_hist->num_rows.' '.__('item(s) loan history').' | <a href="?p=download_loan_history">Histórico de Empréstimos</a></div>'."\n".$_result;
        return $_result;
    }
